            ...
            <div class="col-md-10">
                ...
                <form>
                    <table class="table table-borderless">
                        <tr>
                            <td>Full Name:</td>
                            <td><input type="text" class="form-control" name="user" value="${sessionScope.user.fullname}"></td> 
                        </tr>
                        <tr>
                            <td>Gender:</td>
                            <td><input type="text" class="form-control" name="user" value="${sessionScope.user.gender}"></td> 
                        </tr>
                        <tr>
                            <td>Email:</td>
                            <td><input type="text" class="form-control" name="user" value="${sessionScope.user.email}"></td> 
                        </tr>
                        <tr>
                            <td>Phone:</td>
                            <td><input type="text" class="form-control" name="user" value="${sessionScope.user.phone}"></td> 
                        </tr>
                        <tr>
                            <td>Address:</td>
                            <td><input type="text" class="form-control"  name="user" value="${sessionScope.user.address}"></td> 
                        </tr>
                        <tr>
                            <td>Notes:</td>
                            <td><input type="text" class="form-control" name="user" value=""></td> 
                        </tr>
                        <tr>
                            <td colspan="2">
