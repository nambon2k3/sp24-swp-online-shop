...
public class ConfirmOrderController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        EmailService.sendEmail(user.getEmail(), "Thanks Card", "Thanks for trying our product, we want to hear your feedback!\n Link feedback: http://localhost:8080/swp-online-shop/customer/order-detail?orderId=" + orderId);
