 ...
 * @author Legion
 */
@WebServlet(name="ListFeedBackController", urlPatterns={"/customer/list-feedback"})
public class ListFeedBackController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<OrderDetail> orderedProducts = orderDAO.getOrderDetailsNotFeedbackedByUserId(user.getId());
