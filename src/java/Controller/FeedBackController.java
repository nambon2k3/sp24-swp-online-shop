...
public class FeedBackController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        OrderDetail orderedProducts = orderDAO.getOrderDetailById(id);
        ...
        request.setAttribute("product", orderedProducts);
    ...
    throws ServletException, IOException {
        ...
        feedback.setOrderDetailId(Integer.parseInt(request.getParameter("id")));
        feedback.setRating(Integer.parseInt(request.getParameter("rate")));
